...
export function RouteLoadingOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-background/72 px-4 backdrop-blur-xl">
      <div className="route-loading-scan pointer-events-none absolute inset-0 opacity-45" />

      <div className="relative w-full max-w-[430px] overflow-hidden rounded-[8px] border border-cyan-300/25 bg-card/92 p-6 text-center shadow-2xl shadow-cyan-950/30">
        <div className="absolute inset-x-0 top-0 h-[2px] bg-gradient-to-r from-cyan-300 via-indigo-300 to-amber-200" />
        ...
        <div className="mx-auto flex h-28 w-28 items-center justify-center">
          <div className="relative h-24 w-24">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="flex h-12 w-12 items-center justify-center rounded-[8px] border border-cyan-300/25 bg-cyan-300/10 text-cyan-100 shadow-lg shadow-cyan-950/40">
        ...
        <div className="mt-3 flex items-center justify-center gap-2 text-[10px] font-semibold uppercase tracking-[0.18em] text-cyan-100">
          <Activity className="h-3.5 w-3.5" />
          {status}
        </div>
        <h2 className="mt-2 text-2xl font-semibold leading-tight text-foreground">{targetLabel}</h2>
        <p className="mt-2 text-sm leading-5 text-muted-foreground">Menyiapkan insight, chart, dan data terbaru...</p>

        <div className="mt-6 overflow-hidden rounded-full border border-border bg-background/70 p-1">
          <div className="relative h-2 overflow-hidden rounded-full bg-muted">
            <div className="route-loading-progress absolute inset-y-0 w-1/2 rounded-full bg-gradient-to-r from-cyan-300 via-indigo-300 to-amber-200" />
          </div>
        </div>

        <div className="mt-4 inline-flex items-center gap-2 rounded-[8px] border border-border bg-muted/20 px-3 py-1.5 text-xs text-muted-foreground">
