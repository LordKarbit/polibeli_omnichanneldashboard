...
export interface MarketplacePurchaseChannelSummary {
  channelKey: string;
  channel: string;
...
export interface GtSalesPerformance {
  name: string;
  areaManager: string;
...
export interface GtCityPerformance {
  city: string;
  province: string;
  orders: number;
  customers: number;
...
export interface GtPerformanceAnalytics {
  summary: {
    bookedGMV: number;
    activeGMV: number;
    orders: number;
  ...
  salesPerformance: GtSalesPerformance[];
  cityPerformance: GtCityPerformance[];
...
export interface DashboardData {
  ...
  marketplacePurchaseChannels: MarketplacePurchaseChannelSummary[];
  ...
  gtPerformance: GtPerformanceAnalytics;
...
export function clearDashboardDataCache() {
  ...
  if (typeof window !== "undefined") {
    window.dispatchEvent(new CustomEvent("dashboard-filter-options-refresh"));
  }
}
